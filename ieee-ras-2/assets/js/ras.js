/* =============================================================
   IEEE RAS — MITS Gwalior Student Chapter
   ras.js — interactions, scroll behavior, particles, animations
============================================================= */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (canvas && canvas.getContext) {
    ...
    let particles = [];
    let width, height;
    const COLORS = ['rgba(123,47,247,0.35)', 'rgba(214,51,132,0.30)', 'rgba(142,68,173,0.28)'];
